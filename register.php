...
// === reCAPTCHA v2 config ===
$RECAPTCHA_SITE_KEY   = '6Lc30cErAAAAAKeW4qZ8oJzB88mBrkG8NKtDDf5j'; // site key (punyamu)
$RECAPTCHA_SECRET_KEY = '6Lc30cErAAAAAJfqmtUOAvgFGlaEpgbVCdWTI7cd'; // <-- GANTI dengan secret key pasangan
